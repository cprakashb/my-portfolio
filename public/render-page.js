...
function u(){return(u=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e}).apply(this,arguments)}function h(e,t){if(null==e)return{};var a,i,r={},n=Object.keys(e);for(i=0;i<n.length;i++)t.indexOf(a=n[i])>=0||(r[a]=e[a]);return r}var g,p=[.25,.5,1,2],m=[750,1080,1366,1920],f=[320,654,768,1024,1366,1600,1920,2048,2560,3440,3840,4096],v=function(e){return console.warn(e)},w=function(e,t){return e-t},y=function(e){return e.map(function(e){return e.src+" "+e.width+"w"}).join(",\n")};function b(e){var t=e.lastIndexOf(".");if(-1!==t){var a=e.substr(t+1);if("jpeg"===a)return"jpg";if(3===a.length||4===a.length)return a}}function E(e){var t=e.layout,a=void 0===t?"constrained":t,i=e.width,n=e.height,o=e.sourceMetadata,s=e.breakpoints,l=e.aspectRatio,c=e.formats,d=void 0===c?["auto","webp"]:c;return d=d.map(function(e){return e.toLowerCase()}),a=camelcase__WEBPACK_IMPORTED_MODULE_2___default()(a),i&&n?u({},e,{formats:d,layout:a,aspectRatio:i/n}):(o.width&&o.height&&!l&&(l=o.width/o.height),"fullWidth"===a?(i=i||o.width||s[s.length-1],n=n||Math.round(i/(l||1.3333333333333333))):(i||(i=n&&l?n*l:o.width?o.width:n?Math.round(n/1.3333333333333333):800),l&&!n?n=Math.round(i/l):l||(l=i/n)),u({},e,{width:i,height:n,aspectRatio:l,layout:a,formats:d}))}function k(e,t){var a;return void 0===t&&(t=20),null==(a=(0,(e=E(e)).generateImageSource)(e.filename,t,Math.round(t/e.aspectRatio),e.sourceMetadata.format||"jpg",e.fit,e.options))?void 0:a.src}function S(e){var t,a=(e=E(e)).pluginName,r=e.sourceMetadata,n=e.generateImageSource,o=e.layout,s=e.fit,l=e.options,c=e.width,d=e.height,h=e.filename,f=e.reporter,w=void 0===f?{warn:v}:f,k=e.backgroundColor,S=e.placeholderURL;if(a||w.warn('[gatsby-plugin-image] "generateImageData" was not passed a plugin name'),"function"!=typeof n)throw new Error("generateImageSource must be a function");r&&(r.width||r.height)?r.format||(r.format=b(h)):r={width:c,height:d,format:(null==(t=r)?void 0:t.format)||b(h)||"auto"};var O=new Set(e.formats);(0===O.size||O.has("auto")||O.has(""))&&(O.delete("auto"),O.delete(""),O.add(r.format)),O.has("jpg")&&O.has("png")&&(w.warn("["+a+"] Specifying both 'jpg' and 'png' formats is not supported. Using 'auto' instead"),O.delete("jpg"===r.format?"png":"jpg"));var R=function(e){var t=e.filename,a=e.layout,r=void 0===a?"constrained":a,n=e.sourceMetadata,o=e.reporter,s=void 0===o?{warn:v}:o,l=e.breakpoints,c=void 0===l?m:l,d=Object.entries({width:e.width,height:e.height}).filter(function(e){var t=e[1];return"number"==typeof t&&t<1});if(d.length)throw new Error("Specified dimensions for images must be positive numbers (> 0). Problem dimensions you have are "+d.map(function(e){return e.join(": ")}).join(", "));return"fixed"===r?function(e){var t=e.filename,a=e.sourceMetadata,r=e.width,n=e.height,o=e.fit,s=void 0===o?"cover":o,l=e.outputPixelDensities,c=e.reporter,d=void 0===c?{warn:v}:c,u=a.width/a.height,h=M(void 0===l?p:l);if(r&&n){var m=N(a,{width:r,height:n,fit:s});r=m.width,n=m.height,u=m.aspectRatio}r?n||(n=Math.round(r/u)):r=n?Math.round(n*u):800;var f,w,y=r;if(a.width<r||a.height<n){var b=a.width<r?"width":"height";d.warn((0,common_tags__WEBPACK_IMPORTED_MODULE_1__.stripIndent)(g||(f=["\n    The requested ",' "','px" for the image '," was larger than the actual image "," of ","px. If possible, replace the current image with a larger one."],w||(w=f.slice(0)),f.raw=w,g=f),b,"width"===b?r:n,t,b,a[b])),"width"===b?(r=a.width,n=Math.round(r/u)):r=(n=a.height)*u}return{sizes:h.filter(function(e){return e>=1}).map(function(e){return Math.round(e*r)}).filter(function(e){return e<=a.width}),aspectRatio:u,presentationWidth:y,presentationHeight:Math.round(y/u),unscaledWidth:r}}(e):"constrained"===r?j(e):"fullWidth"===r?j(u({breakpoints:c},e)):(s.warn("No valid layout was provided for the image at "+t+". Valid image layouts are fixed, fullWidth, and constrained. Found "+r),{sizes:[n.width],presentationWidth:n.width,presentationHeight:n.height,aspectRatio:n.width/n.height,unscaledWidth:n.width})}(u({},e,{sourceMetadata:r})),I={sources:[]},W=e.sizes;W||(W=function(e,t){switch(t){case"constrained":return"(min-width: "+e+"px) "+e+"px, 100vw";case"fixed":return e+"px";case"fullWidth":return"100vw";default:return}}(R.presentationWidth,o)),O.forEach(function(e){var t=R.sizes.map(function(t){var i=n(h,t,Math.round(t/R.aspectRatio),e,s,l);if(null!=i&&i.width&&i.height&&i.src&&i.format)return i;w.warn("["+a+"] The resolver for image "+h+" returned an invalid value.")}).filter(Boolean);if("jpg"===e||"png"===e||"auto"===e){var i=t.find(function(e){return e.width===R.unscaledWidth})||t[0];i&&(I.fallback={src:i.src,srcSet:y(t),sizes:W})}else{var r;null==(r=I.sources)||r.push({srcSet:y(t),sizes:W,type:"image/"+e})}});var x={images:I,layout:o,backgroundColor:k};switch(S&&(x.placeholder={fallback:S}),o){case"fixed":x.width=R.presentationWidth,x.height=R.presentationHeight;break;case"fullWidth":x.width=1,x.height=1/R.aspectRatio;break;case"constrained":x.width=e.width||R.presentationWidth||1,x.height=(x.width||1)/R.aspectRatio}return x}var M=function(e){return Array.from(new Set([1].concat(e))).sort(w)};function j(e){var t,a=e.sourceMetadata,i=e.width,r=e.height,n=e.fit,o=void 0===n?"cover":n,s=e.outputPixelDensities,l=e.breakpoints,c=e.layout,d=a.width/a.height,u=M(void 0===s?p:s);if(i&&r){var h=N(a,{width:i,height:r,fit:o});i=h.width,r=h.height,d=h.aspectRatio}i=i&&Math.min(i,a.width),r=r&&Math.min(r,a.height),i||r||(r=(i=Math.min(800,a.width))/d),i||(i=r*d);var g=i;return(a.width<i||a.height<r)&&(i=a.width,r=a.height),i=Math.round(i),(null==l?void 0:l.length)>0?(t=l.filter(function(e){return e<=a.width})).length<l.length&&!t.includes(a.width)&&t.push(a.width):t=(t=u.map(function(e){return Math.round(e*i)})).filter(function(e){return e<=a.width}),"constrained"!==c||t.includes(i)||t.push(i),{sizes:t=t.sort(w),aspectRatio:d,presentationWidth:g,presentationHeight:Math.round(g/d),unscaledWidth:i}}function N(e,t){var a=e.width/e.height,i=t.width,r=t.height;switch(t.fit){case"fill":i=t.width?t.width:e.width,r=t.height?t.height:e.height;break;case"inside":var n=t.width?t.width:Number.MAX_SAFE_INTEGER,o=t.height?t.height:Number.MAX_SAFE_INTEGER;i=Math.min(n,Math.round(o*a)),r=Math.min(o,Math.round(n/a));break;case"outside":var s=t.width?t.width:0,l=t.height?t.height:0;i=Math.max(s,Math.round(l*a)),r=Math.max(l,Math.round(s/a));break;default:t.width&&!t.height&&(i=t.width,r=Math.round(t.width/a)),t.height&&!t.width&&(i=Math.round(t.height*a),r=t.height)}return{width:i,height:r,aspectRatio:i/r}}function O(){return"undefined"!=typeof GATSBY___IMAGE&&GATSBY___IMAGE}new Set;var R=function(e){var t;return function(e){var t,a;return Boolean(null==e||null==(t=e.images)||null==(a=t.fallback)?void 0:a.src)}(e)?e:function(e){return Boolean(null==e?void 0:e.gatsbyImageData)}(e)?e.gatsbyImageData:null==e||null==(t=e.childImageSharp)?void 0:t.gatsbyImageData},I=function(e){var t,a,i;return null==(t=R(e))||null==(a=t.images)||null==(i=a.fallback)?void 0:i.src},W=function(e){var t,a,i;return null==(t=R(e))||null==(a=t.images)||null==(i=a.fallback)?void 0:i.srcSet};function x(e){var t,a=e.baseUrl,i=e.urlBuilder,r=e.sourceWidth,n=e.sourceHeight,o=e.pluginName,s=void 0===o?"getImageData":o,l=e.formats,c=void 0===l?["auto"]:l,d=e.breakpoints,g=e.options,p=h(e,["baseUrl","urlBuilder","sourceWidth","sourceHeight","pluginName","formats","breakpoints","options"]);return null!=(t=d)&&t.length||"fullWidth"!==p.layout&&"FULL_WIDTH"!==p.layout||(d=f),S(u({},p,{pluginName:s,generateImageSource:function(e,t,a,r){return{width:t,height:a,format:r,src:i({baseUrl:e,width:t,height:a,options:g,format:r})}},filename:a,formats:c,breakpoints:d,sourceMetadata:{width:r,height:n,format:"auto"}}))}function _(e,t){var a,i,r,n=e.images,o=e.placeholder,s=u({},h(e,["images","placeholder"]),{images:u({},n,{sources:[]}),placeholder:o&&u({},o,{sources:[]})});return t.forEach(function(t){var a,i=t.media,r=t.image;i?(r.layout!==e.layout&&"development"==="development"&&console.warn('[gatsby-plugin-image] Mismatched image layout: expected "'+e.layout+'" but received "'+r.layout+'". All art-directed images use the same layout as the default image'),(a=s.images.sources).push.apply(a,r.images.sources.map(function(e){return u({},e,{media:i})}).concat([{media:i,srcSet:r.images.fallback.srcSet}])),s.placeholder&&s.placeholder.sources.push({media:i,srcSet:r.placeholder.fallback})): true&&console.warn("[gatsby-plugin-image] All art-directed images passed to must have a value set for `media`. Skipping.")}),(a=s.images.sources).push.apply(a,n.sources),null!=o&&o.sources&&(null==(i=s.placeholder)||(r=i.sources).push.apply(r,o.sources)),s}var T,A=function(t){var a=t.src,i=t.srcSet,r=t.loading,n=t.alt,o=void 0===n?"":n,s=t.shouldLoad,l=t.innerRef,c=h(t,["src","srcSet","loading","alt","shouldLoad","innerRef"]);return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",Object.assign({},c,{decoding:"async",loading:r,src:s?a:void 0,"data-src":s?void 0:a,srcSet:s?i:void 0,"data-srcset":s?void 0:i,alt:o,ref:l}))},z=(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function(t,a){var i=t.fallback,r=t.sources,n=void 0===r?[]:r,o=t.shouldLoad,s=void 0===o||o,l=h(t,["fallback","sources","shouldLoad"]),c=l.sizes||(null==i?void 0:i.sizes),d=react__WEBPACK_IMPORTED_MODULE_0___default().createElement(A,Object.assign({},l,i,{sizes:c,shouldLoad:s,innerRef:a}));return n.length?react__WEBPACK_IMPORTED_MODULE_0___default().createElement("picture",null,n.map(function(t){var a=t.media,i=t.srcSet,r=t.type;return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("source",{key:a+"-"+r+"-"+i,type:r,media:a,srcSet:s?i:void 0,"data-srcset":s?void 0:i,sizes:c})}),d):d});A.propTypes={src:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,alt:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,sizes:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,srcSet:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,shouldLoad:prop_types__WEBPACK_IMPORTED_MODULE_3__.bool},z.displayName="Picture",z.propTypes={alt:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,shouldLoad:prop_types__WEBPACK_IMPORTED_MODULE_3__.bool,fallback:(0,prop_types__WEBPACK_IMPORTED_MODULE_3__.exact)({src:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,srcSet:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,sizes:prop_types__WEBPACK_IMPORTED_MODULE_3__.string}),sources:(0,prop_types__WEBPACK_IMPORTED_MODULE_3__.arrayOf)((0,prop_types__WEBPACK_IMPORTED_MODULE_3__.oneOfType)([(0,prop_types__WEBPACK_IMPORTED_MODULE_3__.exact)({media:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,type:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,sizes:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,srcSet:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired}),(0,prop_types__WEBPACK_IMPORTED_MODULE_3__.exact)({media:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,type:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired,sizes:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,srcSet:prop_types__WEBPACK_IMPORTED_MODULE_3__.string.isRequired})]))};var L=function(t){var a=t.fallback,i=h(t,["fallback"]);return a?react__WEBPACK_IMPORTED_MODULE_0___default().createElement(z,Object.assign({},i,{fallback:{src:a},"aria-hidden":!0,alt:""})):react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",Object.assign({},i))};L.displayName="Placeholder",L.propTypes={fallback:prop_types__WEBPACK_IMPORTED_MODULE_3__.string,sources:null==(T=z.propTypes)?void 0:T.sources,alt:function(e,t,a){return e[t]?new Error("Invalid prop `"+t+"` supplied to `"+a+"`. Validation failed."):null}};var C=(0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(function(t,a){return react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,react__WEBPACK_IMPORTED_MODULE_0___default().createElement(z,Object.assign({ref:a},t)),react__WEBPACK_IMPORTED_MODULE_0___default().createElement("noscript",null,react__WEBPACK_IMPORTED_MODULE_0___default().createElement(z,Object.assign({},t,{shouldLoad:!0}))))});C.displayName="MainImage",C.propTypes=z.propTypes;var q=function(){return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("script",{type:"module",dangerouslySetInnerHTML:{__html:'const t="undefined"!=typeof HTMLImageElement&&"loading"in HTMLImageElement.prototype;if(t){const t=document.querySelectorAll("img[data-main-image]");for(let e of t){e.dataset.src&&(e.setAttribute("src",e.dataset.src),e.removeAttribute("data-src")),e.dataset.srcset&&(e.setAttribute("srcset",e.dataset.srcset),e.removeAttribute("data-srcset"));const t=e.parentNode.querySelectorAll("source[data-srcset]");for(let e of t)e.setAttribute("srcset",e.dataset.srcset),e.removeAttribute("data-srcset");e.complete&&(e.style.opacity=1)}}'}})},D=function(t){var a=t.layout,i=t.width,r=t.height;return"fullWidth"===a?react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{"aria-hidden":!0,style:{paddingTop:r/i*100+"%"}}):"constrained"===a?react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{maxWidth:i,display:"block"}},react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img",{alt:"",role:"presentation","aria-hidden":"true",src:"data:image/svg+xml;charset=utf-8,%3Csvg height='"+r+"' width='"+i+"' xmlns='http://www.w3.org/2000/svg' version='1.1'%3E%3C/svg%3E",style:{maxWidth:"100%",display:"block",position:"static"}})):null},P=function(t){var i=t.children,r=h(t,["children"]);return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment,null,react__WEBPACK_IMPORTED_MODULE_0___default().createElement(D,Object.assign({},r)),i,react__WEBPACK_IMPORTED_MODULE_0___default().createElement(q,null))},H=function(e){return e.replace(/\n/g,"")},F=function(t){var a=t.as,i=void 0===a?"div":a,r=t.children,n=h(t,["as","children"]);return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(i,Object.assign({},n),r)},B=function(t){var a=t.as,i=t.className,r=t.class,n=t.style,o=t.image,s=t.loading,l=void 0===s?"lazy":s,c=t.imgClassName,d=t.imgStyle,g=t.backgroundColor,p=t.objectFit,m=t.objectPosition,f=h(t,["as","className","class","style","image","loading","imgClassName","imgStyle","backgroundColor","objectFit","objectPosition"]);if(!o)return console.warn("[gatsby-plugin-image] Missing image prop"),null;r&&(i=r),d=u({objectFit:p,objectPosition:m,backgroundColor:g},d);var v=o.width,w=o.height,y=o.layout,b=o.images,E=o.placeholder,k=o.backgroundColor,S=function(e,t,a){var i={},r="gatsby-image-wrapper";return O()||(i.position="relative",i.overflow="hidden"),"fixed"===a?(i.width=e,i.height=t):"constrained"===a&&(O()||(i.display="inline-block"),r="gatsby-image-wrapper gatsby-image-wrapper-constrained"),{className:r,"data-gatsby-image-wrapper":"",style:i}}(v,w,y),M=S.style,j=S.className,N=h(S,["style","className"]),R={fallback:void 0,sources:[]};return b.fallback&&(R.fallback=u({},b.fallback,{srcSet:b.fallback.srcSet?H(b.fallback.srcSet):void 0})),b.sources&&(R.sources=b.sources.map(function(e){return u({},e,{srcSet:H(e.srcSet)})})),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(F,Object.assign({},N,{as:a,style:u({},M,n,{backgroundColor:g}),className:j+(i?" "+i:"")}),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(P,{layout:y,width:v,height:w},react__WEBPACK_IMPORTED_MODULE_0___default().createElement(L,Object.assign({},function(e,t,a,i,r,n,o,s){var l={};n&&(l.backgroundColor=n,"fixed"===a?(l.width=i,l.height=r,l.backgroundColor=n,l.position="relative"):("constrained"===a||"fullWidth"===a)&&(l.position="absolute",l.top=0,l.left=0,l.bottom=0,l.right=0)),o&&(l.objectFit=o),s&&(l.objectPosition=s);var c=u({},e,{"aria-hidden":!0,"data-placeholder-image":"",style:u({opacity:1,transition:"opacity 500ms linear"},l)});return O()||(c.style={height:"100%",left:0,position:"absolute",top:0,width:"100%"}),c}(E,0,y,v,w,k,p,m))),react__WEBPACK_IMPORTED_MODULE_0___default().createElement(C,Object.assign({"data-gatsby-image-ssr":"",className:c},f,function(e,t,a,i,r,n,o,s){return void 0===s&&(s={}),O()||(s=u({height:"100%",left:0,position:"absolute",top:0,transform:"translateZ(0)",transition:"opacity 250ms linear",width:"100%",willChange:"opacity"},s)),u({},a,{loading:i,shouldLoad:e,"data-main-image":"",style:u({},s,{opacity:0}),onLoad:function(e){var t=e.currentTarget,a=new Image;a.src=t.currentSrc,a.decode?a.decode().catch(function(){}).then(function(){r(!0)}):r(!0)},ref:void 0})}("eager"===l,0,R,l,void 0,0,0,d)))))},G=function(t){return function(a){var i=a.src,r=a.__imageData,n=a.__error,o=h(a,["src","__imageData","__error","width","height","aspectRatio","tracedSVGOptions","placeholder","formats","quality","transformOptions","jpgOptions","pngOptions","webpOptions","avifOptions","blurredOptions"]);return n&&console.warn(n),r?react__WEBPACK_IMPORTED_MODULE_0___default().createElement(t,Object.assign({image:r},o)):(console.warn("Image not loaded",i),n||"development"!=="development"||console.warn('Please ensure that "gatsby-plugin-image" is included in the plugins array in gatsby-config.js, and that your version of gatsby is at least 2.24.78'),null)}}(B),V=function(e,t){return"fullWidth"!==e.layout||"width"!==t&&"height"!==t||!e[t]?prop_types__WEBPACK_IMPORTED_MODULE_3___default().number.apply((prop_types__WEBPACK_IMPORTED_MODULE_3___default()),[e,t].concat([].slice.call(arguments,2))):new Error('"'+t+'" '+e[t]+" may not be passed when layout is fullWidth.")},U=new Set(["fixed","fullWidth","constrained"]),X={src:(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.isRequired),alt:function(e,t,a){return e.alt||""===e.alt?prop_types__WEBPACK_IMPORTED_MODULE_3___default().string.apply((prop_types__WEBPACK_IMPORTED_MODULE_3___default()),[e,t,a].concat([].slice.call(arguments,3))):new Error('The "alt" prop is required in '+a+'. If the image is purely presentational then pass an empty string: e.g. alt="". Learn more: https://a11y-style-guide.com/style-guide/section-media.html')},width:V,height:V,sizes:(prop_types__WEBPACK_IMPORTED_MODULE_3___default().string),layout:function(e){if(void 0!==e.layout&&!U.has(e.layout))return new Error("Invalid value "+e.layout+'" provided for prop "layout". Defaulting to "constrained". Valid values are "fixed", "fullWidth" or "constrained".')}};G.displayName="StaticImage",G.propTypes=X;
...
/* harmony import */ var _scss_contact_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../scss/contact.scss */ "./src/scss/contact.scss");
/* harmony import */ var _scss_contact_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_scss_contact_scss__WEBPACK_IMPORTED_MODULE_2__);



class Contact extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  componentDidMount() {// document.addEventListener('contextmenu', event => event.preventDefault());
  }
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      class: "col-6"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Email "), "manuvishal@gmail.com "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      class: "col-6"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Contact "), "9705004538 "))))));
  }
...
class Header extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      href: "#news"
    }, "Bookings"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a", {
      href: "#contact"
...
/* harmony import */ var _Contact__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Contact */ "./src/components/Contact.jsx");
...
function Home() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Landing__WEBPACK_IMPORTED_MODULE_1__.default, null);
}
...
/***/ "react-dom/server":
/*!********************************************************************************************!*\
  !*** external "/Users/cbommade/Documents/project-5theye/node_modules/react-dom/server.js" ***!
  \********************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/cbommade/Documents/project-5theye/node_modules/react-dom/server.js");;

/***/ }),

/***/ "react":
/*!***************************************************************************************!*\
  !*** external "/Users/cbommade/Documents/project-5theye/node_modules/react/index.js" ***!
  \***************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = require("/Users/cbommade/Documents/project-5theye/node_modules/react/index.js");;
